...
const SEO = ({
  ...
  image = "https://smart-security-12.preview.emergentagent.com/og-image.jpg",
  url = "https://smart-security-12.preview.emergentagent.com",
  type = "website",
  schema = null
}) => {
  ...
  const defaultSchema = {
    ...
    "url": url,
    "logo": "https://smart-security-12.preview.emergentagent.com/logo.png",
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "potentialAction": {
            ...
            "target": {
              "@type": "EntryPoint",
              "urlTemplate": "https://smart-security-12.preview.emergentagent.com/produtos?q={search_term_string}"
            },
...
export const generateProductSchema = (product) => ({
  ...
  "offers": {
    "@type": "Offer",
    "url": `https://smart-security-12.preview.emergentagent.com/produto/${product.id}`,
    "priceCurrency": "BRL",
    "price": product.price,
