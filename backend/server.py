...
class SEOSettings(BaseModel):
    ...
    id: str = "seo_settings"
    # Site basics
    site_url: str = "https://pagebuilder-debug.preview.emergentagent.com"
...
async def generate_sitemap(current_user: User = Depends(get_current_admin)):
    ...
    try:
        ...
        site_url = seo_settings.get('site_url', 'https://pagebuilder-debug.preview.emergentagent.com') if seo_settings else 'https://pagebuilder-debug.preview.emergentagent.com'
